...
const errorData = {
  domainMalformed: {
    ...
    long: searchTerm =>
      `You have either added a domain without a TLD such as .ewc or you have added unsupported characters`
  },
  unsupported: {
    short: searchTerm =>
    ...
    long: searchTerm =>
      `We currently only support .ewc domains. Support for future domains are planned in the future`
  },
  tooShort: {
    short: searchTerm => (
      <Fragment>
